  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          type="button"
          className={`inline-flex items-center justify-center text-[#FF671F] hover:text-[#EB4700] transition-colors ${className ?? ""}`}
...
export const TOOLTIPS = {
  ...
  commission: "ค่า Commission คือส่วนแบ่งที่แพลตฟอร์มหักจากยอดขายของร้าน ปกติ 30% สำหรับไทยช่วยไทยพลัส 23%",
  thaiPlus: "ไทยช่วยไทยพลัส คือโปรแกรมพิเศษที่ลดค่า Commission เหลือ 23% เพื่อช่วยร้านอาหารพาร์ทเนอร์",
  ...
  vatOnGP: "VAT 7% บน GP คือภาษีที่แพลตฟอร์มหักจากค่า Commission ก่อนจ่ายให้ร้าน",
