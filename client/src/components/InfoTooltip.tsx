...
export const TOOLTIPS = {
  ...
  commission: "ค่า Commission คือส่วนแบ่งที่ GrabFood หักจากยอดขายของร้าน ปกติ 30% สำหรับไทยช่วยไทยพลัส 23%",
  thaiPlus: "ไทยช่วยไทยพลัส คือโปรแกรมพิเศษของ GrabFood ที่ลดค่า Commission เหลือ 23% เพื่อช่วยร้านอาหารไทย",
  ...
  vatOnGP: "VAT 7% บน GP คือภาษีที่ GrabFood หักจากค่า Commission ก่อนจ่ายให้ร้าน",
